...
# summary(forest_fun_syn_wide); str(forest_fun_syn_wide)


### Load the forest_fun_helper table
forest_fun_helper <- read.table("forest_functions_helper_16.01.25.txt", header = T, sep = "\t")
# To check names, dimensions etc.
# dim(forest_fun_helper);str(forest_fun_helper);head(forest_fun_helper)
...
# codedYear == 4444 --> Value was averaged across years (keep as is, do not convert to NA)
